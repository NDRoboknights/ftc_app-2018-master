...
public class TeleOp2 extends customTeleOp
{
    //bot
    ...
    public void loop()
    {
        ...
        {
            bot.actuator.setPower(gamepad2.right_stick_y);
        }else{
            bot.actuator.setPower(0);
        }

        //lifts intake
        if(gamepad2.dpad_up && gamepad2.left_trigger>JOYSTICK_THRESHOLD)
        {
            bot.liftMotor.setPower(gamepad2.left_trigger);
        }else{
            bot.liftMotor.setPower(0);
        }
        //lowers intake
        if(gamepad2.dpad_down && gamepad2.left_trigger>JOYSTICK_THRESHOLD)
        {
            bot.liftMotor.setPower(-gamepad2.left_trigger);
        }else{
            bot.liftMotor.setPower(0);
